...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC000_ROUTE {0b1000011} \
   CONFIG.MSC001_ROUTE {0b1000101} \
   CONFIG.MSC002_ROUTE {0b1001001} \
   CONFIG.MSC003_ROUTE {0b1010001} \
   CONFIG.MSC004_ROUTE {0b1100001} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000040420000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x0000000040430000} \
   ...
   CONFIG.SEG004_BASE_ADDR {0x0000000041200000} \
...
proc create_hier_cell_m04_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC004_ROUTE {0b101} \
   CONFIG.SSC005_ROUTE {0b101} \
   CONFIG.SSC006_ROUTE {0b101} \
   CONFIG.SSC007_ROUTE {0b101} \
   CONFIG.SSC008_ROUTE {0b101} \
   CONFIG.SSC009_ROUTE {0b101} \
   CONFIG.SSC010_ROUTE {0b101} \
   CONFIG.SSC011_ROUTE {0b101} \
   CONFIG.SSC012_ROUTE {0b101} \
   CONFIG.SSC013_ROUTE {0b101} \
   CONFIG.SSC014_ROUTE {0b101} \
   CONFIG.SSC015_ROUTE {0b101} \
