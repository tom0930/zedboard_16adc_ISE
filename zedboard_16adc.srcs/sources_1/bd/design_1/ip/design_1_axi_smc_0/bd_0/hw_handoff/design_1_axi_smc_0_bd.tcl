...
proc create_hier_cell_s06_nodes { parentCell nameHier } {
  ...
  # Create instance: s06_ar_node, and set properties
  set s06_ar_node [ create_bd_cell -type ip -vlnv xilinx.com:ip:sc_node:1.0 s06_ar_node ]
  set_property -dict [ list \
   CONFIG.ACLKEN_CONVERSION {0} \
   CONFIG.ACLK_RELATIONSHIP {1} \
   CONFIG.ADDR_WIDTH {32} \
  ...
  # Create instance: s06_r_node, and set properties
  set s06_r_node [ create_bd_cell -type ip -vlnv xilinx.com:ip:sc_node:1.0 s06_r_node ]
  set_property -dict [ list \
   CONFIG.ACLKEN_CONVERSION {0} \
   CONFIG.ACLK_RELATIONSHIP {1} \
   CONFIG.ADDR_WIDTH {32} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_SC_AR_1 [get_bd_intf_pins S_SC_AR] [get_bd_intf_pins s06_ar_node/S_SC]
  connect_bd_intf_net -intf_net S_SC_R_1 [get_bd_intf_pins S_SC_R] [get_bd_intf_pins s06_r_node/S_SC]
  connect_bd_intf_net -intf_net s06_ar_node_M_SC [get_bd_intf_pins M_SC_AR] [get_bd_intf_pins s06_ar_node/M_SC]
  connect_bd_intf_net -intf_net s06_r_node_M_SC [get_bd_intf_pins M_SC_R] [get_bd_intf_pins s06_r_node/M_SC]

  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s06_ar_node/m_sc_aclk] [get_bd_pins s06_r_node/s_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s06_ar_node/m_sc_aresetn] [get_bd_pins s06_r_node/s_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s06_ar_node/s_sc_aclk] [get_bd_pins s06_r_node/m_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s06_ar_node/s_sc_aresetn] [get_bd_pins s06_r_node/m_sc_aresetn]
...
proc create_hier_cell_s05_nodes { parentCell nameHier } {
  ...
  # Create instance: s05_aw_node, and set properties
  set s05_aw_node [ create_bd_cell -type ip -vlnv xilinx.com:ip:sc_node:1.0 s05_aw_node ]
  set_property -dict [ list \
   CONFIG.ACLKEN_CONVERSION {0} \
   CONFIG.ACLK_RELATIONSHIP {1} \
   CONFIG.ADDR_WIDTH {32} \
  ...
  # Create instance: s05_b_node, and set properties
  set s05_b_node [ create_bd_cell -type ip -vlnv xilinx.com:ip:sc_node:1.0 s05_b_node ]
  set_property -dict [ list \
   CONFIG.ACLKEN_CONVERSION {0} \
   CONFIG.ACLK_RELATIONSHIP {1} \
   CONFIG.ADDR_WIDTH {32} \
  ...
  # Create instance: s05_w_node, and set properties
  set s05_w_node [ create_bd_cell -type ip -vlnv xilinx.com:ip:sc_node:1.0 s05_w_node ]
  set_property -dict [ list \
   CONFIG.ACLKEN_CONVERSION {0} \
   CONFIG.ACLK_RELATIONSHIP {1} \
   CONFIG.ADDR_WIDTH {32} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_SC_AW_1 [get_bd_intf_pins S_SC_AW] [get_bd_intf_pins s05_aw_node/S_SC]
  connect_bd_intf_net -intf_net S_SC_B_1 [get_bd_intf_pins S_SC_B] [get_bd_intf_pins s05_b_node/S_SC]
  connect_bd_intf_net -intf_net S_SC_W_1 [get_bd_intf_pins S_SC_W] [get_bd_intf_pins s05_w_node/S_SC]
  connect_bd_intf_net -intf_net s05_aw_node_M_SC [get_bd_intf_pins M_SC_AW] [get_bd_intf_pins s05_aw_node/M_SC]
  connect_bd_intf_net -intf_net s05_b_node_M_SC [get_bd_intf_pins M_SC_B] [get_bd_intf_pins s05_b_node/M_SC]
  connect_bd_intf_net -intf_net s05_w_node_M_SC [get_bd_intf_pins M_SC_W] [get_bd_intf_pins s05_w_node/M_SC]

  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s05_aw_node/m_sc_aclk] [get_bd_pins s05_b_node/s_sc_aclk] [get_bd_pins s05_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s05_aw_node/m_sc_aresetn] [get_bd_pins s05_b_node/s_sc_aresetn] [get_bd_pins s05_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s05_aw_node/s_sc_aclk] [get_bd_pins s05_b_node/m_sc_aclk] [get_bd_pins s05_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s05_aw_node/s_sc_aresetn] [get_bd_pins s05_b_node/m_sc_aresetn] [get_bd_pins s05_w_node/s_sc_aresetn]
...
proc create_hier_cell_s04_nodes { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s04_ar_node/m_sc_aclk] [get_bd_pins s04_r_node/s_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s04_ar_node/m_sc_aresetn] [get_bd_pins s04_r_node/s_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s04_ar_node/s_sc_aclk] [get_bd_pins s04_r_node/m_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s04_ar_node/s_sc_aresetn] [get_bd_pins s04_r_node/m_sc_aresetn]
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC000_ROUTE {0b00000000} \
   CONFIG.SSC001_ROUTE {0b00000001} \
   CONFIG.SSC002_ROUTE {0b00000010} \
   CONFIG.SSC003_ROUTE {0b00000100} \
   CONFIG.SSC004_ROUTE {0b00001000} \
   CONFIG.SSC005_ROUTE {0b00010000} \
   CONFIG.SSC006_ROUTE {0b00100000} \
   CONFIG.SSC007_ROUTE {0b01000000} \
   CONFIG.SSC008_ROUTE {0b10000000} \
   CONFIG.SSC009_ROUTE {0b00000000} \
   CONFIG.SSC010_ROUTE {0b00000000} \
   CONFIG.SSC011_ROUTE {0b00000000} \
   CONFIG.SSC012_ROUTE {0b00000000} \
   CONFIG.SSC013_ROUTE {0b00000000} \
   CONFIG.SSC014_ROUTE {0b00000000} \
   CONFIG.SSC015_ROUTE {0b00000000} \
   CONFIG.SSC_ROUTE_WIDTH {8} \
   CONFIG.S_ID_WIDTH {4} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins S05_ACLK] [get_bd_pins S06_ACLK] [get_bd_pins S07_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins S07_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:S00_AXI:S01_AXI:S02_AXI:S03_AXI:S04_AXI:S05_AXI:S06_AXI:S07_AXI} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_SC_AR_4 [get_bd_intf_pins s06_axi2sc/M_SC_AR] [get_bd_intf_pins s06_nodes/S_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_3 [get_bd_intf_pins s05_axi2sc/M_SC_AW] [get_bd_intf_pins s05_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_4 [get_bd_intf_pins s07_axi2sc/M_SC_AW] [get_bd_intf_pins s07_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_5 [get_bd_intf_pins m00_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M00_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_3 [get_bd_intf_pins s05_nodes/S_SC_B] [get_bd_intf_pins switchboards/M05_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_4 [get_bd_intf_pins s07_nodes/S_SC_B] [get_bd_intf_pins switchboards/M07_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_5 [get_bd_intf_pins m00_nodes/S_SC_B] [get_bd_intf_pins m00_sc2axi/M_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_R_4 [get_bd_intf_pins s06_nodes/S_SC_R] [get_bd_intf_pins switchboards/M06_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_3 [get_bd_intf_pins s05_axi2sc/M_SC_W] [get_bd_intf_pins s05_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_4 [get_bd_intf_pins s07_axi2sc/M_SC_W] [get_bd_intf_pins s07_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_5 [get_bd_intf_pins m00_nodes/S_SC_W] [get_bd_intf_pins switchboards/M00_SC_W]
  ...
  connect_bd_intf_net -intf_net s05_nodes_M_SC_AW [get_bd_intf_pins s05_nodes/M_SC_AW] [get_bd_intf_pins switchboards/S05_SC_AW]
  connect_bd_intf_net -intf_net s05_nodes_M_SC_B [get_bd_intf_pins s05_axi2sc/S_SC_B] [get_bd_intf_pins s05_nodes/M_SC_B]
  connect_bd_intf_net -intf_net s05_nodes_M_SC_W [get_bd_intf_pins s05_nodes/M_SC_W] [get_bd_intf_pins switchboards/S05_SC_W]
  ...
  connect_bd_intf_net -intf_net s06_nodes_M_SC_AR [get_bd_intf_pins s06_nodes/M_SC_AR] [get_bd_intf_pins switchboards/S06_SC_AR]
  connect_bd_intf_net -intf_net s06_nodes_M_SC_R [get_bd_intf_pins s06_axi2sc/S_SC_R] [get_bd_intf_pins s06_nodes/M_SC_R]
