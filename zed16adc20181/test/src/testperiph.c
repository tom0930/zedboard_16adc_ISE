...
int main () 
{
...

   {
      ...
      status = AxiDMASelfTestExample(XPAR_AXI_DMA_1_DEVICE_ID);
...

   {
      ...
      print("\r\n Running AxiDMASelfTestExample() for axi_dma_2...\r\n");

      status = AxiDMASelfTestExample(XPAR_AXI_DMA_2_DEVICE_ID);
...

   {
      ...
      print("\r\n Running AxiDMASelfTestExample() for axi_dma_3...\r\n");

      status = AxiDMASelfTestExample(XPAR_AXI_DMA_3_DEVICE_ID);
...

   {
      ...
      print("\r\nRunning GpioInputExample() for link_err...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_LINK_ERR_DEVICE_ID, &DataRead);
